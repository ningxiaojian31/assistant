...
public class PubOrdersAdapter extends BaseAdapter {

    private List<UserAndPublish> userAndPublishes;
    private Context mContext;

    public PubOrdersAdapter(List<UserAndPublish> userAndPublishes, Context mContext) {
